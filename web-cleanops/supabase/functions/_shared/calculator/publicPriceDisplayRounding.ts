/**
 * ⚠️  FAITHFUL DENO MIRROR of `src/lib/calculator/publicPriceDisplayRounding.ts`.
 *     Kept behaviour-identical by `src/lib/calculator/v2/parity.test.ts` (Slice
 *     V2-E1). The ONLY intentional differences vs. the canonical source are import
 *     specifiers (explicit `.ts` extensions, required by Deno). Any change to the
 *     canonical module must be mirrored here, or the parity test fails.
 *
