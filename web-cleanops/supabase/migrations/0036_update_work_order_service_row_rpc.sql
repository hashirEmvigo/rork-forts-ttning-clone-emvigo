-- ============================================================================
-- CleanOps — CORE-WRITES-WORKORDERS-A1.2.2a
-- Update one Work Order service row transactionally
-- ============================================================================
--
-- This RPC is intentionally narrow: it updates allowlisted non-staffing,
-- non-protocol, non-booking service-row fields in the parent
-- work_orders.data.serviceRows aggregate and the matching flat
-- work_order_service_rows row in one database transaction. It does not touch
-- booking queue, occurrence exceptions, protocols, time reporting, payroll,
-- invoices, customer agreements, or auth/profile tables.
-- ============================================================================
